...
public interface IClubRepository : IEntityRepositoryBase<Guid, Club>
{
    ...
    Task<bool> HasExistingClubOwnershipAsync(string userId, CancellationToken cancellationToken);
    ...
    Task<bool> HasClubOwnershipAsync(string userId, Guid clubId, CancellationToken cancellationToken);
    ...
    Task<Guid> CreateWithOwnershipAsync(Club club, string userId, string userEmail, string userName, CancellationToken cancellationToken);
}